...
<span class="line"><span>        sys.exit(1)</span></span></code></pre></div><h2 id="命令行调用处理" tabindex="-1">命令行调用处理 <a class="header-anchor" href="#命令行调用处理" aria-label="Permalink to &quot;命令行调用处理&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes catppuccin-latte catppuccin-mocha vp-code" tabindex="0"><code><span class="line"><span>&quot;C:\\Program Files\\Blender Foundation\\Blender 4.3\\blender.exe&quot; --background --python &quot;E:\\blender2FBX\\export_fbx_in_place.py&quot; -- &quot;D:\\角色&quot;</span></span></code></pre></div><p><img src="`+o+'" alt="alt text"></p><h2 id="从一个blender文件批量导出多个文件" tabindex="-1">从一个Blender文件批量导出多个文件 <a class="header-anchor" href="#从一个blender文件批量导出多个文件" aria-label="Permalink to &quot;从一个Blender文件批量导出多个文件&quot;">​</a></h2><p><a href="https://github.com/mrtripie/Blender-Super-Batch-Export?tab=readme-ov-file" target="_blank" rel="noreferrer">https://github.com/mrtripie/Blender-Super-Batch-Export?tab=readme-ov-file</a></p>',14)])])}const h=n(t,[["render",c]]);export{g as __pageData,h as default};
