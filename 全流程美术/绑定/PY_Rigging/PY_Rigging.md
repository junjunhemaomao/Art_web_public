# Python Facial Rigging
![](./fg1.jpg)
[YouTube 地址](https://www.youtube.com/watch?v=4rcDrbgD1zI&list=PLUug4IT0YMuEQw4yTyWt6n80QMcHd71kf)  
[Git代码仓库](https://github.com/MarkSchipper/Python-Scripts) 
## Part 1
### 创建定位器
对于每个曲线的顶点，作者希望创建一个定位器，以便更好地可视化它们的位置。
...
class FaceJoints():
    ...
    def __init__(self):
        self.CreatFaceWindow(self)


    def CreatFaceWindow(self, void):
        cmds.window("Facial Rig")
        cmds.rowColumnLayout(nc=2)
        cmds.button(label="Create Face Locators",width=200,c=self.Locators)
